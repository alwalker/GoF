...
Namespace DoFactory.HeadFirst.Composite.MenuIterator
	...
	Public Class Waitress
		Public Sub PrintVegetarianMenu(ByVal menuComponent As MenuComponent)
			Dim _iterator As IEnumerator(Of MenuComponent) = menuComponent.CreateIterator()

			Do While _iterator.MoveNext()
				Dim menu As MenuComponent = _iterator.Current
				If TypeOf menu Is Menu Then
					PrintVegetarianMenu(menu)
				ElseIf menu.Vegetarian Then
					menu.Print()
				End If
			Loop
		End Sub
	...
	Public MustInherit Class MenuComponent
		...
		Public MustOverride Function CreateIterator() As IEnumerator(Of MenuComponent)
	...
	Public Class Menu
		...
		Public Overrides Sub Print()
			...
			For Each mc As MenuComponent In _menuComponents
				mc.Print()
			Next mc
		End Sub

		Public Overrides Function CreateIterator() As IEnumerator(Of MenuComponent)
