<%@ Page Language="vb" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.vb" Inherits="ASPNETWebApplication.WebShop.Cart" Title="Shopping Cart" %>
	 ...
	 <asp:GridView ID="GridViewCart" SkinID="CartSkin"
		...
		<Columns>
		  ...
		  <asp:TemplateField>
			...
			<ItemTemplate>
			  <asp:Label ID="LabelSubtotal" Runat="Server" Font-Names="Arial" Font-Size="10pt" Text='<%#String.Format("{0:c}", Double.Parse(Eval("UnitPrice").ToString()) * Integer.Parse(Eval("Quantity").ToString()))%>'></asp:Label>
			</ItemTemplate>
		  </asp:TemplateField>
