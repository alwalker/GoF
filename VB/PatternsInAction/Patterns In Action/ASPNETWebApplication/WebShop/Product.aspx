<%@ Page Language="vb" MasterPageFile="~/SiteMasterPage.Master" AutoEventWireup="true" CodeBehind="Product.aspx.vb" Inherits="ASPNETWebApplication.WebShop.Product" Title="Product Details" %>
<%@ MasterType TypeName="ASPNETWebApplication.SiteMasterPage" %>
<%@ Import Namespace="ActionServiceReference" %>
	...
	<asp:DetailsView ID="DetailViewProduct" runat="server" 
		 ...
		 <Fields>
		  <asp:TemplateField HeaderText="Category&nbsp;" ItemStyle-BackColor="Moccasin" ItemStyle-Font-Bold="True" >
			<ItemTemplate>
			  <asp:Label id="LabelCategory" runat="server" Text='<%#(TryCast(Eval("Category"), Category)).Name%>' />
			</ItemTemplate>
		  </asp:TemplateField>
