...
**
** Copyright Data & Object Factory, LLC, 2008-2009
** All Rights Reserved.
**
** At the bottom of this document an Application, a User 
** and a Membership entry is added for Patterns in Action application.
*/
/**********************************************************************/
...
INSERT INTO [aspnet_Applications] ([ApplicationName],[LoweredApplicationName],[ApplicationId])VALUES('/','/', '60e17a52-7f43-41cd-8d08-6125d37a624b')
go

INSERT INTO [aspnet_Users]([ApplicationId],[UserId],[UserName],[LoweredUserName],[IsAnonymous],[LastActivityDate]) VALUES('60e17a52-7f43-41cd-8d08-6125d37a624b','13877c8b-507f-4ae4-81bd-c0c81e94658d','debbie','debbie',0,'11/21/2008 1:59:41 AM')
go

INSERT INTO [aspnet_Membership]([ApplicationId],[UserId],[Password],[PasswordFormat],[PasswordSalt],
[Email],[LoweredEmail],[IsApproved],[IsLockedOut],[CreateDate],[LastLoginDate],
...
('60e17a52-7f43-41cd-8d08-6125d37a624b','13877c8b-507f-4ae4-81bd-c0c81e94658d','If/etWLO1zQhe3LoK8hdJ8Nlv3Y=',1,'fDnhbskomi1ZiUKyRSDkWQ==',
'debbie@yourcompany.com','debbie@yourcompany.com',1,0,'7/19/2008 6:38:00 PM','11/21/2008 1:59:41 AM',
'7/19/2008 6:38:00 PM','1/1/1754 12:00:00 AM',0,'1/1/1754 12:00:00 AM',0,'1/1/1754 12:00:00 AM')
go

PRINT '-------------------------------------------------'
PRINT 'Completed installation of Patterns In Action user'
PRINT '-------------------------------------------------'