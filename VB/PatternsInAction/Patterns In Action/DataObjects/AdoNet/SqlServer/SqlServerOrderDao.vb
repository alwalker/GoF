...
Namespace DataObjects.AdoNet.SqlServer
	...
	''' </summary>
	Public Class SqlServerOrderDao
		...
		' Creates list of orderdetails from data table
		...
		' Create order detail business object from data row
		...
		' Creates order business object from data row
